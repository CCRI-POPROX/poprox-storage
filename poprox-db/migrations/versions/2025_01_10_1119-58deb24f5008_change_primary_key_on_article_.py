...
def upgrade() -> None:
    ...
    op.add_column("article_placements", 
        sa.Column(
            "placement_id",
            sa.UUID,
            primary_key=True,
    ...
    op.create_primary_key("article_placements_pkey", "article_placements", ["placement_id", ])
...
def downgrade() -> None:
    ...
    op.create_primary_key("article_placements_pkey", "article_placements", ["article_id", ])
